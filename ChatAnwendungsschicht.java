 ...
 * <li>VerbindungsaufbauCONF: Client empfängt die Antwort vom Server
 * <p>
...
public class ChatAnwendungsschicht extends Thread
{
     ...
     * @param ici IP-Adresse in <code>ici.ip</code> und Portangabe in <code>ici.port</code>
     * @param sdu wird an die Panterinstanz übertragen
     */
    ...
    {
        System.out.println("ChatAnwendungsschicht: VerbindungsabbauCONF("+ici.toString()+","+"––"+")");
        if(client  != null){
            client.VerbindungsaufbauCONF(ici, sdu);
            
        }else {
            System.err.println("VerbindungsabbauCONF: kein Server");
        }
    }
